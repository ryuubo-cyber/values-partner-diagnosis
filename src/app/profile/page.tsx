...
const FIELDS: FieldDef[] = [
  ...
  {
    key: "partnerMeetingWay",
    label: "パートナー（配偶者）との出会いきっかけ",
    type: "select",
    description: "既婚・パートナーがいる方のみ",
    options: [
      "職場・仕事関係",
      "学生時代（同級生・先輩後輩）",
      "友人・知人の紹介",
  ...
  {
    key: "meetingHistory",
    label: "今までの出会い方（複数選択可）",
    type: "multi",
    maxSelect: 4,
    description: "経験したことのある出会い方を選んでください（最大4つ）",
    options: [
      "マッチングアプリ",
      "職場・仕事関係",
      "学校・大学",
  ...
  },
  {
    ...
    type: "multi",
    maxSelect: 4,
    description: "あてはまるものを選んでください（最大4つ）",
    options: [
      "自炊派（料理が好き・得意）",
      "健康志向（栄養バランス・体に良いものを意識）",
      "グルメ志向（外食好き・食べ歩きが趣味）",
      "手軽さ重視（コンビニ・ファストフード多め）",
      "こだわりなし（出されたものを食べる）",
      "オーガニック・ヴィーガン・自然食志向",
      "お酒好き（飲み会・晩酌が多い）",
      "スイーツ・カフェ好き",
  ...
  {
    key: "futurePlan",
    label: "将来の設計・考え方（複数選択可）",
    type: "multi",
    maxSelect: 4,
    description: "あてはまるものを選んでください（最大4つ）",
    options: [
      "結婚したい（or 結婚生活を充実させたい）",
      "子どもがほしい（or 子育てを楽しみたい）",
      "マイホームを持ちたい",
      "賃貸で身軽に暮らしたい",
      "老後の資金を早めに準備したい",
      "独立・起業したい",
